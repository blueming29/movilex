...
<div class="warp">
	<div class="comment_header">
		...
		<button class="comment_close_button">
			<span class="comment_close"><i class="fas fa-arrow-left"></i></span>
		</button>
		<!-- 영화제목 -->
	...
	<div class="comment_body">
		<form action="comment_write.do">	
			<input type="hidden" name="movie_code" value="${movie_code }" />	
			<input type="hidden" name="eval_point" value="${eval_point }" />
			<!-- 코멘트작성 버튼 클릭시 작성후 contenview 창으로 이동 -->
			<div class="save_button">
			<input type="submit" class="comment_save_button" value="코멘트 작성" /> <br />
			</div>
