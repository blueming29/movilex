...
<body>
   <div class="wrap">
      ...
      <div class="board_body">
         <form action="qnamodifyproc.do" method="post">
            ...
            <div class="board_write_area">
               <div class="board_content_area">
                  <div>
                     <span>글번호 :</span><span>${dto.qna_seq }</span>
                  </div>
                  <input name="qna_title" class="input_title" type="text"
                     size="50" value="${ dto.qna_title}">


                  <textarea name="qna_content" class="input_content" type="text"
                     cols="30" rows="10" size="330" wrap="physical">${ dto.qna_content}</textarea>
               </div>
            </div>
