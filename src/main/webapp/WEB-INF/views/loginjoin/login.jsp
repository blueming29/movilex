 ...
 -->
    ...
    <div id="layerbox" class="layerpop" style="width: 375px; height: 619px;">
        ...
        <article class="layerpop_area">
            ...
            <button type="submit" class="btnBox"><b>로그인</b></button>




            <div class="checkLogin1">회원이 아니신가요? <button class="checkLogin2">회원가입</button></div>
    ...
    <script src="resources/js/gologin.js"></script>
</body></html>